    ...
    if uploaded_file is not None:
        ...
        rename_columns = {'How long have you worked at the organization?': 'Service_Length',
                            ...
                            #   'Which brand do you work in?',
                              ...
                              'How would you describe your national identity?': 'Self_Describe_National_Identity',################################Consider in the analysis
                            ...
                            #   'Can you elaborate on how your difficulty with certain tasks affects you at work?',
                              ...
                              'What advice do you have for the Senior Leadership Team regarding EDI at this company?': 'Advice_for_Senior_Leadership_Team_re_EDI', ########Consider in the analysis
                              ...
                              'Would you agree that you are able to reach your full potential at work?': 'Would you agree that you are able to reach your full potential at work?', ##########consider it in the analysis
                            ...
                            #   'In what ways can this organisation ensure that everyone is treated fairly and can thrive?', ## Is it the same as above question??? if not, consider it in the analysis
                              'We want to support employees in setting up networks for our people if there is demand. What ERG would you be interested in us establishing?': 'We want to support employees in setting up networks for our people if there is demand. What ERG would you be interested in us establishing?', ##############Consider it in the analysis,
        ...
        st.text("Select the standard format for the questions:")
...
################################
    ...
    if 'df' in st.session_state and st.session_state['df'] is not None:
       ...
       # )
        ...
        load_in_8bit_fp32_cpu_offload=False  # Enable offloading to CPU
        )
        #---------------------------------------------------------------------------------
        # Llama 2 Tokenizer
